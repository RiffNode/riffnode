...
// Following Single Responsibility: Handles backing track UI only
// Business logic delegated to BackingTrackManaging protocol
...
struct BackingTrackView: View {
    ...
    var body: some View {
        ...
        .background(backingTrackBackground)
        .fileImporter(
    ...
    private var backingTrackBackground: some View {
